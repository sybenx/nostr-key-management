...
The primary purpose of this project is to allow for increased security of key transfer than the typical copy-paste method. Security is upgraded where possible, within reasonable constraints, to help keep the user key safe and help the user to avoid needing the copy-paste method. 
